...
| Metadata | Schemas, relations, keys, indexes, FK navigation, routines, triggers, direct Depends on / Used by navigation, and read-only DDL | Event triggers, aggregates/window functions, editable DDL |
