...
| Results | Dynamic table/JSON view, virtualized loaded results, copy/export, 100-row server paging, table-browser filter/sort, PostgreSQL chunked streaming | Cross-driver streaming, spill-to-disk, arbitrary-query server filtering |
