...
| Metadata | Schemas, relations, keys, indexes, FK navigation, PostgreSQL routines, PostgreSQL/SQLite triggers and read-only DDL | Dependencies, event triggers, editable DDL |
