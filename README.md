...
| Metadata | Schemas, tables, views, columns, keys, indexes, bidirectional FK navigation, PostgreSQL routines and read-only DDL | Dependencies, triggers, editable DDL |
