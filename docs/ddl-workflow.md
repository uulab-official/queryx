...
- Schema Compare now offers an explicit **Apply in transaction** action for executable, same-dialect changes. Manual-review changes and read-only sessions remain blocked. Object-specific form builders are still planned.
