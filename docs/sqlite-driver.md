...
- `database_metadata` — returns schemas, tables, views, columns, indexes, foreign keys, triggers, FK/trigger-owner dependencies, and explicit empty routine/event-trigger arrays for Explorer/Inspector
