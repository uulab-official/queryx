...
- Safe Mode uses the shared structure-aware UPDATE/DELETE guard, but still has no affected-row estimate; native parser/plan-backed estimation is required before production use.
