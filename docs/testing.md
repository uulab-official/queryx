...
8. **Manual smoke checks** cover the high-value UI path: connect state → run query → filter/sort result → export → inspect and navigate object dependencies.
