...
| Table browsing and keyed edits | Partial — SQLite/PostgreSQL/MySQL primary-key browsing with dialect-aware server filter/sort, deterministic pagination, and conflict-aware edits | Available | Available | Available | Available | [results](results.md), `tableBrowse.test.ts`, edit-batch tests |
