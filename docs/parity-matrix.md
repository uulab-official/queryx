...
| Schema diff and migration history | Partial — same-dialect baseline with dependency-ordered table/column/index/FK/view forward and rollback preview; privilege preflight/history pending | Available | Partial | Partial | Available | [schema compare](schema-compare.md), [roadmap](../ROADMAP.md) |
