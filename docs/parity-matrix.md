...
| SSH tunnels, keychain, certificate files | Partial — native OS-keychain password storage and PostgreSQL/MySQL/MariaDB CA/client certificate paths; SSH tunnels remain planned | Available | Partial | Partial | Available | [connections](connections.md), [architecture](architecture.md) |
