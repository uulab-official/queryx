...
| DDL inspect → edit → transaction | Partial — safe handoff plus table/column/index create/drop forms and type-nullability editing; rename/index-alter/view/constraint forms pending | Available | Available | Available | Available | [DDL workflow](ddl-workflow.md), [object forms](object-forms.md) |
