...
| DDL inspect → edit → transaction | Partial — safe handoff plus table-create/add-column/type-nullability/drop forms; rename/view/index/constraint forms pending | Available | Available | Available | Available | [DDL workflow](ddl-workflow.md), [object forms](object-forms.md) |
