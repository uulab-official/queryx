...
| Schema/object explorer | Partial — broad SQLite/PostgreSQL metadata, MySQL basics, SQL Server tables/views/columns/databases/schemas/routines/triggers, and Oracle tables/views/columns/databases/schemas plus PK/index/composite-FK, standalone/package routine, table/view trigger, and FK/trigger-owner dependency metadata | Available | Available | Available | Available | [metadata explorer](metadata-explorer.md), [SQL Server driver](sqlserver-driver.md), [Oracle driver](oracle-driver.md) |
