...
| Schema diff and migration history | Partial — same-dialect cross-connection/session baseline with table/column/index/FK/view SQL preview and deterministic category ordering; graph/history pending | Available | Partial | Partial | Available | [schema compare](schema-compare.md), [roadmap](../ROADMAP.md) |
