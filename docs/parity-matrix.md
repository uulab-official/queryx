...
| DDL inspect → edit → transaction | Partial — safe handoff plus table/column/index-create forms and type-nullability/drop editing; rename/index-drop/view/constraint forms pending | Available | Available | Available | Available | [DDL workflow](ddl-workflow.md), [object forms](object-forms.md) |
