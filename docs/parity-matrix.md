...
| DDL inspect → edit → transaction | Partial — safe handoff plus table/column/index create/drop forms, view creation, and type-nullability editing; rename/index-alter/view alter/drop/constraint forms pending | Available | Available | Available | Available | [DDL workflow](ddl-workflow.md), [object forms](object-forms.md) |
