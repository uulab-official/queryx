...
- [x] Table creation, add-column, type/nullability/non-PK-drop, ordered UNIQUE/non-unique index-create, and regular index-drop forms with validation, SQL preview, explicit transaction apply, driver-aware manual review, and metadata refresh; rename/index-alter/view/constraint forms remain planned
