...
- [x] Table creation, add-column, type/nullability/non-PK-drop, ordered UNIQUE/non-unique index-create, regular index-drop, and read-only view-create forms with validation, SQL preview, explicit transaction apply, driver-aware manual review, and metadata refresh; rename/index-alter/view alter/drop/constraint forms remain planned
