...
- [x] Table creation and add-column forms with schema/column/type/required/primary-key validation, SQL preview, explicit transaction apply, and metadata refresh; alter/drop/view/index/constraint forms remain planned
