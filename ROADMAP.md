...
- [x] PostgreSQL/MySQL/MariaDB session explorer with active/idle/waiting state, wait-event visibility, refresh, and safe query cancellation; lock graph and long-running diagnostics remain planned
